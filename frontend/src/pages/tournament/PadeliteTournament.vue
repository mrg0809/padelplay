  ...
  export default {
    ...
    setup() {
      ...
      const obtenerGrupos = async () => {
        ...
        try {
          ...
          for (const partido of partidos) {
            ...
            // Sumar puntaje_equipo1 al equipo1Id
            puntajes[equipo1Id] = (puntajes[equipo1Id] || 0) + partido.puntaje_equipo1;
            
            // Sumar puntaje_equipo2 al equipo2Id
          ...
          // Actualizar la variable reactiva grupos
      ...
      const goToCuadroFinal = () => {
        // Redireccionar al usuario al cuadro final del torneo
        router.push("/cuadro-final");
      };
