      ...
      <q-page-container>
        <q-page class="q-pa-md">
          <q-card class="text-white">
            <q-card-section>
              <h3 class="text-white">Entrenamiento:</h3>
            </q-card-section>
            <q-card-section>
              <p><strong>Club:</strong> {{ reservationDetails.clubName }}</p>
              <p><strong>Coach:</strong> {{ reservationDetails.coachName }}</p>
              ...
              <p><strong>Participantes:</strong>  {{ reservationDetails.people }}</p>
  ...
  export default {
    ...
    setup() {
      ...
      const reservationDetails = ref({
        ...
        coachName: route.query.coachName || "No especificado",
